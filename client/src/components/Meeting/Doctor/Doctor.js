                ...
                <Grid container spacing={0}>
                    <Grid item xs={12}>
                        <Typography className={classes.fieldTitle} variant="h6">
                            ...
                            <br/>
                            { props.data.isMeetingRequested ? 'One Meeting needs to be Approved' : 'There is no meeting to be approved!!!'}
                        </Typography>

                        <Button disabled={!props.data.isMeetingRequested} onClick={props.onClickApproveMeeting}>
                            Approve a Meeting
                        </Button>
                        { props.data.isMeetingApproved ? (
                            <Button onClick={props.onClickJoinMeeting}>
                                Join a Meeting
                            </Button>
                        ) : ''}
                    </Grid>
